    ...
    for m in range(total_months + 1):
        ...
        if m > 0:
            ...
            if m <= contemplation_month:
                ...
                # Pós-contemplação: parcela fixa + reajuste anual em degrau (INCC)
                # Parcela e saldo devedor reajustam juntos → zeram no mesmo mês
                ...
                if remaining_installments <= 0:
                    ...
                    # Reajuste anual em degrau: a cada 12 meses pós-contemplação
                    ...
                    post_balance_debt = debt_at_contemplation * annual_adj * (remaining_installments / max(total_remaining_at_contemplation, 1))
